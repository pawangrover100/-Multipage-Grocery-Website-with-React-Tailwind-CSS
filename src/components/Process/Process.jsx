    ...
    return (
      <div key={item.id} className={`flex-1 basis-[300px] ${item.id% 2 ===0 ? 'md:-mt-100': ''}`}>
        ...
        <div className="flex items-center gap-x-5 mt-10 ">
          <span className="  w-15 h-15 flex justify-center items-center  text-3xl bg-gradient-to-b from-orange-400 to-orange-600 text-white  rounded-full">{item.icon}</span>
